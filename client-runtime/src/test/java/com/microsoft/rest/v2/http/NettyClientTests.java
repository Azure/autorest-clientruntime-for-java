...
public class NettyClientTests {
    ...
    public void testMultipleSubscriptionsEmitsError() {
        ...
        StepVerifier.create(response.bodyAsByteArray())
                .expectNextCount(0)
                // TODO: Check with smaldini, what is the verifier operator equivalent to
                //  http://reactivex.io/RxJava/javadoc/io/reactivex/observers/BaseTestConsumer.html#awaitDone-long-java.util.concurrent.TimeUnit-
    ...
    public void testFlowableWhenServerReturnsBodyAndNoErrorsWhenHttp500Returned() {
        ...
        StepVerifier.create(response.bodyAsString())
                // TODO: .awaitDone(20, TimeUnit.SECONDS) [See previous todo]
                .expectNext("error")
                .verifyComplete();
    ...
    public void testFlowableBackpressure() {
        ...
        StepVerifier.create(response.body(), stepVerifierOptions)
                ...
                // TODO: Check with smaldini, what is the verifier operator to ignore all next emissions
                //  or something similar to .awaitDone(20, TimeUnit.SECONDS) in http://reactivex.io/RxJava/javadoc/io/reactivex/observers/BaseTestConsumer.html#awaitDone-long-java.util.concurrent.TimeUnit-
...
//        assertEquals(numRequests * LONG_BODY.getBytes(StandardCharsets.UTF_8).length, numBytes);
    ...
    @Test
    @Ignore("Not a valid test for reactor-netty based Http client since HttpClient is not responsible to manage pool")
    public void testRequestBeforeShutdownSucceeds() {
...
//        factory.close();
    ...
    @Test
    @Ignore("Not a valid test for reactor-netty based Http client since HttpClient is not responsible to manage pool")
    public void testRequestAfterShutdownIsRejected() {
//        final HttpClientFactory factory = new NettyClient.Factory();
//        HttpClient client = factory.create(null);
...
//        }
    ...
    @Test
    @Ignore("Not a valid test for reactor-netty based Http client since HttpClient is not responsible to manage pool")
    // This test is already ignored in V2 due to 'intermittent failures'
    public void testInFlightRequestSucceedsAfterCancellation() {
