 ...
 *   Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @HeaderParam("accept-language") String acceptLanguage, @HeaderParam("User-Agent") String userAgent);
 *
 *   "accept-language" generated by the HTTP client will be overwritten by the user passed value.
 *
 * Example 3:
 *   {@literal @}GET("subscriptions/{subscriptionId}/providers/Microsoft.ServiceBus/namespaces")
 *   Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @HeaderParam("Authorization") String token);
 *
