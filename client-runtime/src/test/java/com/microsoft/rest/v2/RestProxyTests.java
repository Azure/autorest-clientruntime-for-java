...
// TODO: Remove this test which is invalid once we move to reactor.
// Reason: In v2 - out of Flowable, Single, Maybe and Observable only first 3 are supported as
// return type of generated async methods. This test is specifically for validating the exception
// thrown if generated code ever use Observable return type. v3 supports reactor Flux and Mono
// and there is no other reactor async type equivalent to no-back-pressure-aware Observable.
//
//
//    @Host("https://httpbin.org")
...
//
     @Test
     @Ignore("Not a valid test for reactor-netty based rest proxy since generated async methods are either Flux or Mono, there is no other async type in reactor")
