...
public class ServiceFuture<T> extends CompletableFuture<T> {
    ...
    // TODO Generator: fromBody based on Maybe is removed there is no corresponding reactor type. Generator has to be updated
    //  to use Mono<T> instead.
    // public static <T> ServiceFuture<T> fromBody(final Maybe<T> maybe, final ServiceCallback<T> callback)

    // TODO Generator: fromBody based on Completable is removed there is no corresponding reactor type. Generator has to be updated
    //  to use Mono<Void> instead.
